...
function Footer() {
  ...
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="lg:flex lg:items-start lg:gap-8 justify-evenly">

      <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-2 lg:gap-y-16">
        ...
        <li>
            <a
              href="https://github.com/vahidhusyn"
              rel="noreferrer"
              target="_blank"
          ...
          <li>
            <a
              rel="noreferrer"
              target="_blank"
              class="text-textColor cursor-not-allowed transition hover:opacity-75"
            >
          ...
          <li>
            <a
              rel="noreferrer"
              target="_blank"
              class="text-textColor transition hover:opacity-75 cursor-not-allowed"
            >
    ...
    <div class="mt-8 border-t border-gray-100 pt-8">
      <div class="sm:flex sm:justify-between">
        <p class="text-base text-textColor">	 Made with &#x1F49C; from Vahid.</p>

        <ul class="mt-8 flex flex-wrap justify-start gap-4 text-base sm:mt-0 lg:justify-end">
          <li>
            <a href="https://vahidhusyn.github.io/" class="text-textColor transition hover:opacity-75"> About Me</a>
          </li>

          <li>
            <p href="#" class="text-textColor transition hover:opacity-75"> Privacy Policy </p>
          </li>

          <li>
            <p href="#" class="text-textColor transition hover:opacity-75"> Cookies </p>
          </li>
        </ul>
      </div>
    </div>
